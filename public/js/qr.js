(function () {
  ...
  // Single landscape label sized for Epson LW-1000P with LK-6YBP tape
  // (24mm wide black-on-yellow). Height = 24mm (tape width), length = 80mm.
  ...
  function openLabelWindow(items, docTitle) {
    ...
    var html =
      ...
      '<style>' +
      '@page { size: 80mm 24mm; margin: 0; }' +
      'html, body { margin: 0; padding: 0; }' +
      'body { font-family: Arial, sans-serif; -webkit-print-color-adjust: exact; print-color-adjust: exact; }' +
      '.label { box-sizing: border-box; width: 80mm; height: 24mm; background: #FFE500; color: #000; ' +
      ...
      '.tag { font-size: 11pt; font-weight: bold; line-height: 1.05; word-break: break-all; }' +
      '.descr { font-size: 7.5pt; margin-top: 0.6mm; line-height: 1.15; overflow: hidden; ' +
      'display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; word-break: break-all; }' +
      '.meta { font-size: 7pt; margin-top: 0.6mm; line-height: 1.2; word-break: break-all; }' +
      '.meta div { margin: 0; }' +
      '.meta span { font-weight: bold; }' +
      '.qrw { width: 18mm; flex-shrink: 0; display: flex; align-items: center; justify-content: center; ' +
      'background: #fff; border: 0.4pt solid #ccc; }' +
      '.qrw img { width: 17mm; height: 17mm; }' +
      '</style></head><body>' +
